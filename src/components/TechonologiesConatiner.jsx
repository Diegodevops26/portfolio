import {
  ...
  const technologies = [
    ...
    { id: "Swagger", name: "Swagger", icon: <DiSwagger />, description: "Documentação de API basicamente fazer a modelagem, a documentar e até gerar código para desenvolvimento de APIs" },
  ];
